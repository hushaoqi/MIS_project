...
sql = """create table salary_month( ID char(15) NOT NULL,
...
cur.execute(sql)#创建表
#插入数据
t= [('user','201807','张三','5000','4000','400','8600'),
    ('user','201806','张三','5000','4000','500','8500'),
    ('user','201805','张三','5000','3000','400','7600')]
