...
class Ui_Tip(object):
    def setupUi(self, Tip):
        ...
        self.label.setGeometry(QtCore.QRect(120, 10, 220, 31))
        font = QtGui.QFont()
        font.setFamily(".")
    ...
    def retranslateUi(self, Tip):
        ...
        self.label.setText(_translate("Tip", "凯撒加密解密算法原理"))
        ...
        self.label_6.setText(_translate("Tip", "解密算法则和这个是一样的过程。比如A的ASCLL码是65，向右偏移5个偏"))
        self.label_7.setText(_translate("Tip", "移量就是65+5=70，对应密文的ASCLL码就是70，转化为字符就是F，这"))
